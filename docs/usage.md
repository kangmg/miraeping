...
This guide covers the user-side setup for two independent features:
...
The two features are separate. Notify messages do **not** require the Slack command server to be running. Slack slash commands do **not** require you to install the bash helper or Python package locally.
